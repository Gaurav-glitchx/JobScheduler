...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'pending', enum: ['pending', 'running', 'completed', 'failed'] }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: { to: 'user@example.com', subject: 'Hello' }, required: false, type: Object }),
